...
def _agent_runs_source() -> DataSourceDefinition:
    return DataSourceDefinition(
        ...
        fields=[
            ...
            _field(
                "cached_prompt_tokens", "Cached prompt tokens", DataFieldType.INTEGER
            ),
            _field(
        ...
        metrics=[
            ...
            _metric(
                ...
                DataAggregation.DISTINCT_COUNT,
                "session_id",
            ),
            _metric(
                "prompt_tokens_total",
...
def _agent_trace_events_source() -> DataSourceDefinition:
    return DataSourceDefinition(
        ...
        metrics=[
            ...
            _metric(
                "sessions_with_memory_write_count",
                "Sessions with memory write count",
                DataAggregation.DISTINCT_COUNT,
                "memory_write_session_id",
            ),
        ],
...
def _contexts_source() -> DataSourceDefinition:
    return DataSourceDefinition(
        ...
        metrics=[
            ...
            _metric(
                "total_messages", "Total messages", DataAggregation.SUM, "message_count"
            ),
            _metric(
