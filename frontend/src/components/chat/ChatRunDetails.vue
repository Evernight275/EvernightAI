...
<template>
  <dialog id="chat-run-details" :ref="setDialog" class="chat-details-panel"
    ...
    <header class="chat-panel-header">
      <div class="chat-panel-heading"><span class="chat-panel-symbol"><Activity :size="18" aria-hidden="true" /></span><div><h2 id="chat-details-title">运行详情</h2><p>查看本次请求与工具执行情况</p></div></div>
    ...
    <div class="chat-details-content">
      ...
      <section class="chat-run-advanced"><h3><Code2 :size="15" aria-hidden="true" /> 开发者信息</h3>
